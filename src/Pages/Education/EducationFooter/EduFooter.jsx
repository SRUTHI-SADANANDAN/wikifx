                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="f_widget company_widget wow fadeInLeft" data-wow-delay="0.2s" style={{ visibility: 'visible', animationDelay: '0.2s', animationName: 'fadeInLeft' }}>
                                ...
                                <form action="#" class="f_subscribe_two mailchimp" method="post" novalidate="true" _lpchecked="1">
                                    <input type="email" name="email" class="form-control memail" placeholder="Email Address" />
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-7">
                            <p class="mb-0 f_400">© Wiki-fx 2024 all rights reserved</p>
                        </div>
                        <div class="col-lg-6 col-sm-5 text-right">
                            <p>Money makes Power <i class="icon_heart"></i> by <a href="https://www.google.com/search?q=Trading+stretegy" target="_blank">Trading-stretegy</a></p>
                        </div>
                    </div>
                </div>
            </div>
